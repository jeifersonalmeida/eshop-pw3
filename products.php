								...
								foreach($productsList as $product): if($product == null) continue; ?>
									<div class="col-md-4 col-sm-6 col-xs-6">
										<div class="product product-single">
											...
											<div class="product-body">
												<h3 class="product-price">R$ <?=number_format($product["preco"], 2, ",", ".")?><del class="product-old-price">R$ <?=number_format($product["preco"]/0.8, 2, ",", ".")?></del></h3>
												<div class="product-rating">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
												...
												<?php $url = "id=".$product["id"]."&param=".$product["tipo"]."&" ?>
												<h2 class="product-name"><a href="product.php?<?php echo $url ?>"><?=substr($product["nome"], 0, 30)."..."?></a></h2>
