                            ...
                            <table class="shopping-cart-table table">
                                ...
                                <tbody>
                                    ...
                                    foreach($_SESSION["cartList"]["products"] as $key=>$value){
                                        $sum += (float) $value["preco"];
                                        $url = "id=".$value["id"]."&param=".$value["tipo"]."&";
                                        echo '<tr>
                                            <td class="thumb"><img src="'. $value["imagem"] .'" alt="'. $value["nome"] .'"></td>
                                            <td class="details">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>SUBTOTAL</th>
                                        <th colspan="2" class="sub-total">R$<?php echo $sum ?></th>
                                    </tr>
                                    <tr>
                                        <th class="empty" colspan="3"></th>
                                        <th>SHIPING</th>
                                    ...
                                    <tr>
                                        <th class="empty" colspan="3"></th>
                                        <th>TOTAL</th>
                                        <th colspan="2" class="total">R$<?php echo $sum ?></th>
                                    </tr>
                                </tfoot>
                            </table>
