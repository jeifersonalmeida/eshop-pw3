	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="active"><?php echo $elem["nome"]?></li>
			</ul>
		</div>
	</div>
    <!-- /BREADCRUMB -->
				...
				<div class="product product-details clearfix">
					<div class="col-md-6">
						<div id="product-main-view">
							<div class="product-view">
								<img src="<?php echo $elem["imagem"]?>" alt="<?php echo $elem["nome"]?>">
							</div>
					...
					<div class="col-md-6">
						<div class="product-body">
							...
							<h2 class="product-name"><?php echo $elem["nome"]?></h2>
							<h3 class="product-price">R$<?php echo $elem["preco"]?> <del class="product-old-price">$45.00</del></h3>
							<div>
